...
\begin{tabular}{l c c r@{\,$\pm$\,}l r@{\,$\pm$\,}l}
\toprule
\textbf{Target Engine} & \textbf{Flash} & \textbf{SRAM} & \multicolumn{2}{c}{\textbf{Inference}} & \multicolumn{2}{c}{\textbf{Execution}} \\
& \textbf{[KB]} & \textbf{[KB]} & \multicolumn{2}{c}{\textbf{Time [$\mu$s]}} & \multicolumn{2}{c}{\textbf{Jitter [$\mu$s]}} \\
\midrule
TFLM (Arena)                     & 142.6          & 28.4          & 820 & 45  & \multicolumn{2}{c}{$\pm 110$} \\
MicroPython (\texttt{simtoreal}) & 38.2           & 14.6          & 1450 & 90 & \multicolumn{2}{c}{$\pm 240$} \\
\textbf{Generated C Header}      & \textbf{6.8}   & \textbf{1.2}  & \textbf{74} & \textbf{4} & \multicolumn{2}{c}{$\pm \mathbf{8}$} \\
\bottomrule
\end{tabular}
\end{table}
